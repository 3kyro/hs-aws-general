...
serviceNamespaceToText ServiceNamespaceTranscribe = "transcribe"
...
parseServiceNamespace =
    ServiceNamespaceAwsPortal <$ P.text "aws-portal"
        ...
        <|> ServiceNamespaceTranscribe <$ P.text "transcribe"
        <?> "Service Namespace"
